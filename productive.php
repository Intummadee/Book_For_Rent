...
$result = mysqli_query($connection, "SELECT * FROM BOOKS WHERE category = 'Productive'");
?>
...
Travel</a></li>
<li class="active"><a href="productive.php" class="text-decoration-none px-3 py-2 d-block">
Productivity</a></li>
