...
$result = mysqli_query($connection, "SELECT * FROM BOOKS WHERE category = 'History'");
?>
...
Horror</a></li>
<li class="active"><a href="history.php" class="text-decoration-none px-3 py-2 d-block">
History</a></li>
