...
$result = mysqli_query($connection, "SELECT * FROM BOOKS WHERE category = 'Mystery'");
?>
...
History</a></li>
<li class="active"><a href="mystery.php" class="text-decoration-none px-3 py-2 d-block">
Mystery</a></li>
