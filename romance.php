...
$result = mysqli_query($connection, "SELECT * FROM BOOKS WHERE category = 'Romance'");
?>
...
Language</a></li>
<li class="active"><a href="romance.php" class="text-decoration-none px-3 py-2 d-block">
Romance</a></li>
